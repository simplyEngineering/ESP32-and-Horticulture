...
|   |   |
|---|:--|	
|<image src = "/processors.s.jpg" width = "100%">|Examples of the microcontrollers used from left to right (typical specs): <br><b>ESP32-CAM:</b>ESP32-S chip, 2MP OV2640 camera, 4MB PSRAM,  microSD card, 10 accessible GPIOs and power pins, on-board WiFi antenna and IPEX connector for external antenna.<br><b>ESP8266:</b>Single core 32-bit processor,17 GPIO pins, I2C/SPI, 10-bit ADC, WiFi<br><b>ESP32 Heltec WiFi32</b><br><b>ESP32  Heltec LoraWan</b>|
