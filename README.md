...
|<image src="images/ESP8266%20autonomous%20data%20acquisition%2C%20telemetry%20and%20control.jpg" width="50%">|A data acquisition, WEB server, client and controller module. Serves an interactive monitoring and control page on the local network (below left) and uploads parametric measurements via a PHP interface to a public (secured) SQL server (see sample database data list and derived chart below centre and right). |
|---|:--|
