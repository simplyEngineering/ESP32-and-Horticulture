...
<table>
	...
	<tr>
		...
		The primary purpose of this module is to acquire temperature, relative humidity, light, atmospheric pressure and weight measurements, assemble the data into packets and transmit them over a LoRa link to its receiver counterpart at the gateway. The loadcell platform uses a pair of 10kG strain guages linked to a bridge amplifier and 12-bit ADC via an I2C bus.  One of the strain guages can just be seen in the photograph, sandwiched between the upper and lower platforms. See code <a href="code/dataLogger6_noSleep3_compensate3_noCO2_git.ino">here</a></td>
	</tr>
</table>
<br><br>
<table>
