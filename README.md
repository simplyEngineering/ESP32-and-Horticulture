...
|   |   |
|---|:--|	
|<image src = "/processors.s.jpg" width = "95%">|Examples of the microcontrollers used from left to right: <br>ESP32-CAM<br>ESP8266<br>ESP32 Heltec WiFi32<br>ESP32  Heltec LoraWan|
