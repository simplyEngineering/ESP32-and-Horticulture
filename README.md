...
|   |   |
|---|:--|	
|<image src = "/processors.s.jpg" width = "95%">|Examples of the microcontrollers used from left to right: ESP32-CAM,<br>ESP8266, ESP32 Heltec WiFi32, ESP32  Heltec LoraWan|
